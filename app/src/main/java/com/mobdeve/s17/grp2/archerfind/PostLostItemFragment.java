...
public class PostLostItemFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Report Lost Item");
        toolbar.setNavigationOnClickListener(v -> Navigation.findNavController(v).navigateUp());

        view.findViewById(R.id.btn_submit_post).setOnClickListener(v -> {
            Snackbar.make(v, "Lost item reported!", Snackbar.LENGTH_SHORT).show();
            Navigation.findNavController(v).navigateUp();
        });

        // Photo picker — UI feedback only
